...
- [ ] All CRM list pages read from the API
- [ ] All CRM detail pages resolve the record from the route `[id]`
- [ ] Lead conversion atomically creates Account + Contact
- [ ] Opportunity stage changes are recorded in stage history
